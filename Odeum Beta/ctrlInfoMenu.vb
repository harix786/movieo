Public Class ctrlInfoMenu
    ...
    Private Sub Ctrls_MouseMove(sender As Object, e As MouseEventArgs) Handles btnSettings.MouseMove, btnContact.MouseMove, btnChangelog.MouseMove, btnLegal.MouseMove, btnFAQ.MouseMove, btnAbout.MouseMove
        sender.ForeColor = Color.White
        sender.ColorFillSolid = Color.FromArgb(10, 18, 31)
    End Sub
    ...
    Public Sub CtrlsLeave_Leave(sender As Object, e As EventArgs) Handles btnSettings.MouseLeave, btnContact.MouseLeave, btnChangelog.MouseLeave, btnLegal.MouseLeave, btnFAQ.MouseLeave, btnAbout.MouseLeave
        ...
        sender.ColorFillSolid = Color.FromArgb(24, 32, 45)
    End Sub
