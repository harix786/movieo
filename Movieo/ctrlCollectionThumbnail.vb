...
Public Class ctrlCollectionThumbnail
    Public Property InfoImdbRatingPoster As Object
    ...
    Private Sub imgCollectionThumbnail_ClickButtonArea(sender As Object, e As EventArgs) Handles imgCollectionThumbnail.ClickButtonArea
        ...
        For Each a In Movieo.storeControlsAllMovies
            For Each ab As Control In a.Controls
                If ab.Name = "InfoImdbId" Then
                    If itemsCollectionMovies.Items.Contains(ab.Text) Then
        ...
        For Each a As String In itemsCollectionMovies.Items
            Try
                If Movieo.itemsSeenList.Items.Contains(Movieo.returnMovieTitle(a)) Then
