Public Class ctrlContextMenuPlayer
    ...
    Private Sub btnDefault_ClickButtonArea(Sender As Object, e As MouseEventArgs) Handles btnDefault.ClickButtonArea
        If frmMovieDetails.infoBackgroundImageLink.Text = "" Then
            frmSelectSource.Opacity = 0.98
        Else
            frmSelectSource.Opacity = 0.85
        End If

        Dim getUrlFromUser As String = Movieo.returnSource(Me, frmMovieDetails.infoTitle.Text + " (" + frmMovieDetails.infoYear.Text + ")", frmMovieDetails.infoWatchLinks.Text, "watch")
    ...
    Private Sub btnVLC_ClickButtonArea(Sender As Object, e As MouseEventArgs) Handles btnVLC.ClickButtonArea
        ...
        Dim getUrlFromUser As String = Movieo.returnSource(frmMovieDetails, frmMovieDetails.infoTitle.Text + " (" + frmMovieDetails.infoYear.Text + ")", frmMovieDetails.infoWatchLinks.Text, "watch")
